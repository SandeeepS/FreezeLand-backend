...
userRouter.post('/addAddress',async(req:Request,res:Response,next:NextFunction) => await controller.addAddress(req,res,next));
...
userRouter.post('/registerService',userAuth,async(req:Request,res:Response,next:NextFunction) => await controller.registerService(req,res,next));
userRouter.get('/getAllServices',async(req:Request,res:Response,next:NextFunction) => controller.getAllServices(req,res,next));
